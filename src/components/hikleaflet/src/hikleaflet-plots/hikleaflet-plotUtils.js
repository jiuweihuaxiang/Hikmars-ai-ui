...
PlotUtils.getAzimuth = function (startPnt, endPnt) {
  ...
  if (endPnt[1] >= startPnt[1] && endPnt[0] >= startPnt[0]) { azimuth = angle + Math.PI } else if (endPnt[1] >= startPnt[1] && endPnt[0] < startPnt[0]) { azimuth = Constants.TWO_PI - angle } else if (endPnt[1] < startPnt[1] && endPnt[0] < startPnt[0]) { azimuth = angle } else if (endPnt[1] < startPnt[1] && endPnt[0] >= startPnt[0]) { azimuth = Math.PI - angle }
  return azimuth
}
...
PlotUtils.getCurvePoints = function (t, controlPoints) {
  let leftControl = PlotUtils.getLeftMostControlPoint(t, controlPoints)
  ...
  let rightControl = PlotUtils.getRightMostControlPoint(t, controlPoints)
