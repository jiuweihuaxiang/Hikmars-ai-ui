...
export let DoubleArrow = function (points) {
...
// goog.inherits(Plot.DoubleArrow, ol.geom.Polygon);
Mixin(DoubleArrow.prototype, Plot.prototype)

DoubleArrow.prototype.finishDrawing = function () {
  if (this.getPointCount() === 3 && this.tempPoint4 != null) { this.points.push(this.tempPoint4) }
...
DoubleArrow.prototype.generate = function () {
  ...
  if (count === 3) { this.tempPoint4 = this.getTempPoint4(pnt1, pnt2, pnt3) } else { this.tempPoint4 = this.points[3] }
  if (count === 3 || count === 4) { this.connPoint = PlotUtils.mid(pnt1, pnt2) } else { this.connPoint = this.points[4] }
